    ...
    .setName('clear')
        ...
        async execute(client, interaction) {
            ...
            if(amount < 1 || amount > 1000){
                ...
                await interaction.reply({content: `\`\`\`\nYou have successfully deleted ${amount} message\`\`\``, ephemeral: false})
            } 
                ...
                setTimeout(async () => {
                    interaction.channel.bulkDelete(left, true)
                    await interaction.reply({content: `You have successfully deleted ${amount} message`, ephemeral: false})
                }, setTimeout(() => {
